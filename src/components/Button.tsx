...
function Button({
  ...
  const variantStyles = {
    primary: `${baseStyles} bg-[#FDBB2A] text-white shadow-[0px_4px_0px_0px_#D59302] sm:shadow-[0px_5px_0px_0px_#D59302] md:shadow-[0px_6px_0px_0px_#D59302] hover:translate-y-[1px] sm:hover:translate-y-[1.5px] md:hover:translate-y-[2px] hover:shadow-[0px_2px_0px_0px_#D59302] sm:hover:shadow-[0px_2.5px_0px_0px_#D59302] md:hover:shadow-[0px_3px_0px_0px_#D59302] active:translate-y-[3px] sm:active:translate-y-[4px] md:active:translate-y-[6px] active:shadow-[0px_0px_0px_0px_#e6bb00]`,
    secondary: `${baseStyles} bg-[#4B4B4B] text-white shadow-[0px_4px_0px_0px_#373737] sm:shadow-[0px_5px_0px_0px_#373737] md:shadow-[0px_6px_0px_0px_#373737] hover:translate-y-[1px] sm:hover:translate-y-[1.5px] md:hover:translate-y-[2px] hover:shadow-[0px_2px_0px_0px_#373737] sm:hover:shadow-[0px_2.5px_0px_0px_#373737] md:hover:shadow-[0px_3px_0px_0px_#373737] active:translate-y-[3px] sm:active:translate-y-[4px] md:active:translate-y-[6px] active:shadow-[0px_0px_0px_0px_#2c2c2c]`,
    adminpanel:
      "flex items-center justify-center w-full transition-all ease-in-out duration-200 cursor-pointer border-none outline-none focus:outline-none rounded-full font-bold " +
      "py-2 px-4 text-sm sm:py-2 sm:px-6 sm:text-base md:py-2 md:px-8 md:text-base lg:py-2 lg:px-10 lg:text-lg " +
      "bg-[#FDBB2A] text-white shadow-[0px_3px_0px_0px_#D59302] sm:shadow-[0px_4px_0px_0px_#D59302] md:shadow-[0px_5px_0px_0px_#D59302] " +
      "hover:translate-y-[1px] sm:hover:translate-y-[1.5px] md:hover:translate-y-[1.5px] " +
      "hover:shadow-[0px_1.5px_0px_0px_#D59302] sm:hover:shadow-[0px_2px_0px_0px_#D59302] md:hover:shadow-[0px_2.5px_0px_0px_#D59302] " +
      "active:translate-y-[3px] sm:active:translate-y-[4px] md:active:translate-y-[6px] active:shadow-[0px_0px_0px_0px_#e6bb00]",
    delete: `${baseStyles} bg-red-500 text-white shadow-[0px_4px_0px_0px_#D9534F] sm:shadow-[0px_5px_0px_0px_#D9534F] md:shadow-[0px_6px_0px_0px_#D9534F] hover:translate-y-[1px] sm:hover:translate-y-[1.5px] md:hover:translate-y-[2px] hover:shadow-[0px_2px_0px_0px_#D9534F] sm:hover:shadow-[0px_2.5px_0px_0px_#D9534F] md:hover:shadow-[0px_3px_0px_0px_#D9534F] active:translate-y-[3px] sm:active:translate-y-[4px] md:active:translate-y-[6px] active:shadow-[0px_0px_0px_0px_#C9302C]`,
  };

  const disabledStyles =
    variant === "primary"
      ? `${baseStyles} opacity-50 cursor-not-allowed bg-[#FDBB2A] text-white shadow-[0px_4px_0px_0px_#D59302] sm:shadow-[0px_5px_0px_0px_#D59302] md:shadow-[0px_6px_0px_0px_#D59302]`
      : `${baseStyles} opacity-50 cursor-not-allowed bg-[#4B4B4B] text-white shadow-[0px_4px_0px_0px_#373737] sm:shadow-[0px_5px_0px_0px_#373737] md:shadow-[0px_6px_0px_0px_#373737]`;
