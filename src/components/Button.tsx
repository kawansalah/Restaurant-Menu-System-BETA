...
function Button({
  ...
  const disabledStyles =
    variant === "primary"
      ? `${baseStyles} opacity-50 cursor-not-allowed bg-main text-white shadow-[0px_4px_0px_0px_#A27F37] sm:shadow-[0px_5px_0px_0px_#A27F37] md:shadow-[0px_6px_0px_0px_#A27F37]`
