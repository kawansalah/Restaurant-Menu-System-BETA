...
const AdminLogin: React.FC = () => {
  ...
  // const setCredentialsDefault = () => {
  //   setCredentials({
  //     username: "admin@kawan.dev",
  //     password: "admin123",
  //   });
  // };
  ...
  return (
    <div
      className={`min-h-screen h-full w-full flex justify-center items-center ${themeClasses.bgPrimary} transition-colors duration-300`}
    >
      ...
      <div
        className={`flex items-center justify-center border-1 ${themeClasses.borderBottomNav} flex-row-reverse ${themeClasses.bgTopbar} w-[900px] h-[600px] overflow-hidden p-6 rounded-[30px] ${themeClasses.topbarShadowStyle}`}
      >
        {/* Left Panel - Branding */}
        <div
          className={`h-full w-full flex flex-col justify-center items-center px-8 ${
            themeClasses.isDark
        ...
        <div
          className={`h-full w-full flex flex-col justify-between py-8 ${
            isRTL ? "pl-16 px-10" : "pr-16 px-10"
          }`}
        >
          <div className="w-full">
            ...
            <p
              className={`${themeClasses.textSecondary} text-base font-normal mb-8`}
            >
              {t.subtitle[language]}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-6">
            <div className="space-y-1">
              <Input
                ...
                icon={getUsernameIcon("currentColor", 24)}
                iconPosition="left"
                error={usernameError}
              />
            </div>
            ...
            <div className="space-y-1">
              <Input
                ...
                icon={getPasswordIcon("currentColor", 24)}
                iconPosition="left"
                error={passwordError}
              />
            </div>
            ...
            <div className="my-3 px-10">
              <Button type="submit" onClick={() => handleSubmit}>
                {t.signIn[language]} {getLoginIcon("currentColor", 24)}
              </Button>
            </div>
          </form>
